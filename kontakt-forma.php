	...
	if (empty($formErrors)) {
        //Uradi akciju koju je korisnik trazio
            ...
            try {
                ...
                $mail->addAddress('stefanceric88@gmail.com', 'Stefan Ceric');     // Add a recipient
                ...
                $errorMessage = 'An error occured while sending e-mail. Please try again.';
